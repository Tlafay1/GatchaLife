                ...
                <CardContent>
                    <div class="space-y-2 text-sm">
                        <div>
                            ...
                            <div class="bg-muted p-2 rounded text-xs font-mono break-all">{{ theme.keywords_theme }}
                            </div>
                        </div>
            ...
            <DialogContent class="sm:max-w-[600px]">
                ...
                <div class="grid gap-4 py-4 max-h-[60vh] overflow-y-auto px-1">
                    ...
                    <div class="grid gap-2">
                        ...
                        <p class="text-xs text-muted-foreground">Player level required to unlock this theme.</p>
                    </div>

                    <div class="grid gap-2">
                        <Label>Theme Keywords</Label>
                        <Textarea v-model="form.keywords_theme" placeholder="e.g. neon lights, rain, skyscrapers"
                            class="h-20" />
                    </div>

                    <div class="grid gap-2">
                        <Label>Background Prompt</Label>
                        <Textarea v-model="form.prompt_background" placeholder="Full background description..."
                            class="h-24" />
                    </div>
